...
class Train_Dataset(Dataset):
    ...
    def __init__(
        ...
        self.source_vocab = Vocabulary(
            freq_threshold, source_vocab_max_size, head_tokenize, src_lang
        )
        self.source_vocab.build_vocabulary(self.source_texts.tolist())
        # Initialize target vocab object and build vocabulary
        self.target_vocab = Vocabulary(
            freq_threshold, target_vocab_max_size, head_tokenize, trg_lang
        )
...
class Validation_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (
            torch.tensor(numerialized_source),
...
def get_train_loader(
    dataset, batch_size, num_workers=0, shuffle=True, pin_memory=True
...
def get_valid_loader(
    dataset, train_dataset, batch_size, num_workers=0, shuffle=True, pin_memory=True
):
...
def master_loader(train_df, val_df, min_freq, src_lang, trg_lang, batch_size):
    train_dataset = Train_Dataset(
        ...
        src_lang,
        trg_lang,
        freq_threshold=min_freq,
        source_vocab_max_size=50000,
        target_vocab_max_size=50000,
    )
    ...
    return (
        ...
        source_vocab_len,
        target_vocab_len,
        train_dataset.target_vocab.itos,
    )
